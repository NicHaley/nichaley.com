...
export default function PostImage({ src, alt }: InlineImageProps) {
  return (
    <div className="flex flex-col gap-2 mb-4 p-4 md:p-8 aspect-video bg-linear-to-t from-stone-200 to-stone-100  dark:bg-stone-700 rounded items-center justify-center">
      <Image
        src={src}
        alt={alt ?? ""}
